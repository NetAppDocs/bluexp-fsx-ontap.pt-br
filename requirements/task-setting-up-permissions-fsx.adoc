...
Ao adicionar novas credenciais para o FSX for ONTAP da fábrica de carga de armazenamento no BlueXP , você precisará decidir em que nível de permissões, ou _modo operacional_, você gostaria de operar. Para descobrir e implantar recursos da AWS, como o FSX for ONTAP, você precisará de permissões _somente leitura_ ou _somente leitura/gravação_. O BlueXP  FSX for ONTAP funcionará no modo _básico_, a menos que você selecione o modo _somente leitura_ ou o modo _leitura/gravação_. _Somente leitura_ são as mesmas permissões de visualização. _Read/Write_ são as mesmas permissões de operação. link:https://docs.netapp.com/us-en/workload-setup-admin/operational-modes.html["Saiba mais sobre os modos operacionais"].
...
. Para os recursos de carga de trabalho que oferecem uma escolha de níveis de permissão (leitura/gravação ou somente leitura), selecione o tipo de permissões que estarão disponíveis com essas credenciais. link:https://docs.netapp.com/us-en/workload-setup-admin/operational-modes.html["Saiba mais sobre as permissões, também conhecidas como modos operacionais"^].
