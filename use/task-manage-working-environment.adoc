...
Se você está familiarizado com o Gerenciador de sistemas do ONTAP, você pode gerenciar um sistema de arquivos FSX for ONTAP diretamente do BlueXP  usando a interface do Gerenciador de sistemas do ONTAP.
